import { readSheet, appendRow, findRowIndex } from './client';
import type { TeamUpdate, UserRole } from '@/types';
import { v4 as uuidv4 } from 'uuid';

const HEADERS = ['id', 'submitted_by', 'role', 'date', 'goals', 'achievements', 'blockers', 'submitted_at'];
...
export async function submitUpdate(data: Omit<TeamUpdate, 'id' | 'submitted_at'>): Promise<TeamUpdate> {
